...
dict =
    ...
    , { latin = "hunaak qubba3A fii shanTatak yaa buub"
    ...
    , { latin = "hunaak kitaab Saghiir wa-wishaaH kabiir fii ShanTatii"
      , kana = "フナーク キターブ サギール ワ ウィシャーフ カビール フィー シャンタティー"

module Linecolor001 exposing (main)

-- fork from Gakufu005.elm
-- I want to colore each line toggled  HA.style "background" "pink" "yellow"
-- add linecolor : String to Model, change init
-- update is ChangeLineColor like Picshare012 ToggleColor in Msg
-- if color is "yellow" then "pink" else "pink"
--
--
-- This idea does not work because line printing does not puroduce Msg
...
update msg model =
    case msg of
        ToggleColor ->
            ( { model
                | linecolor =
                    if model.linecolor == "yellow" then
                        "pink"
                ...
                (List.indexedMap
                    (\index music ->
                        p
                            ...
                            , HA.style "background" model.linecolor
                            ]
                            [ text music.title
                            , button

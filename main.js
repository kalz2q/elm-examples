...
var author$project$Main$BlogList = function (a) {
	return {$: 'BlogList', a: a};
};
...
var author$project$Main$viewPage = function (path) {
	var _n0 = A2(elm$url$Url$Parser$parse, author$project$Main$routeParser, path);
	if (_n0.$ === 'Just') {
		switch (_n0.a.$) {
			case 'Home':
				var _n1 = _n0.a;
				...
				return A2(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									elm$html$Html$text('これはプログラムがロードされたModulesです。')
								]))
						]));
			default:
				var _n4 = _n0.a;
...
var author$project$Main$viewRoute = function (url) {
	return author$project$Main$viewPage(url);
};
				...
				_List_fromArray(
					[
						...
						A2(
							...
							_List_fromArray(
								['/home', '/blog/', '/blog/42', '/blog/37', '/blog/?search=cats', '/modules', 'https://guide.elm-lang.org/webapps/navigation.html']))),
						A2(
						elm$html$Html$h2,
						_List_Nil,
						_List_fromArray(
							[
								elm$html$Html$text('各ページの画面です')
							])),
						A2(
						elm$html$Html$div,
						_List_Nil,
						_List_fromArray(
							[
								author$project$Main$viewRoute(model.url)
							]))
					]))
			]),

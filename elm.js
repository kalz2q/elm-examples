						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											A2(elm$html$Html$Attributes$attribute, 'href', 'about.html')
										]),
									_List_fromArray(
										[
											A2(
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									A2(elm$html$Html$Attributes$attribute, 'href', 'mailto:xxxx@gmail.com')
								]),
							_List_fromArray(
								[
									A2(
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													elm$html$Html$Attributes$src('mail.png'),
													elm$html$Html$Attributes$width(40),
													elm$html$Html$Attributes$alt('メール送信')
												]),
											_List_Nil)
										]))
								])),
							...
							_List_fromArray(
								[
									A2(elm$html$Html$Attributes$attribute, 'href', 'https://dotinstall.com'),
								...
								[
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													elm$html$Html$Attributes$src('blog.png'),
													elm$html$Html$Attributes$width(40),
													elm$html$Html$Attributes$alt('ブログサイトへ')
												]),
											_List_Nil)
										]))
								])),
								...
								[
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													elm$html$Html$Attributes$src('photos.png'),
													elm$html$Html$Attributes$width(40),
													elm$html$Html$Attributes$alt('写真サイトへ')
												]),
											_List_Nil)
										]))
								]))

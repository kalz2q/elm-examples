...
var author$project$BlueBox002$lavender = A3(mdgriffith$elm_ui$Element$rgb255, 230, 230, 250);
var author$project$BlueBox002$skyblue = A3(mdgriffith$elm_ui$Element$rgb255, 135, 206, 235);
...
var author$project$BlueBox002$main = A2(
	...
	A2(
		...
		_List_fromArray(
			[
				...
				mdgriffith$elm_ui$Element$Background$color(author$project$BlueBox002$lavender)
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						...
						mdgriffith$elm_ui$Element$centerX,
						mdgriffith$elm_ui$Element$centerY,
						mdgriffith$elm_ui$Element$Background$color(author$project$BlueBox002$skyblue)
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								mdgriffith$elm_ui$Element$text('skyblue')
							])),
						A2(
						mdgriffith$elm_ui$Element$row,
						_List_fromArray(
...
_Platform_export({'BlueBox002':{'init':_VirtualDom_init(author$project$BlueBox002$main)(0)(0)}});}(this));
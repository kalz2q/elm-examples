	...
	function (msg, model) {
		...
		switch (msg.$) {
			...
			case 'Delete':
				...
				var beforeTodos = A2(elm$core$List$take, n, model.todoList);
				var afterTodos = A2(elm$core$List$drop, n + 1, model.todoList);
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												elm$html$Html$text('Elm Todo Firebase/Firestore')
											]))
									]))
							]))
					])),

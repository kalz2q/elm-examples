...
var author$project$CounterElmUi$update = F2(
	function (msg, model) {
		if (msg.$ === 'Increment') {
...
var author$project$CounterElmUi$view = function (model) {
	return A2(
		...
		A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							mdgriffith$elm_ui$Element$Events$onClick(author$project$CounterElmUi$Increment)
						]),
					mdgriffith$elm_ui$Element$text('増')),
					A2(
					mdgriffith$elm_ui$Element$el,
					_List_Nil,
					...
					_List_fromArray(
						[
							mdgriffith$elm_ui$Element$Events$onClick(author$project$CounterElmUi$Decrement)
						]),
					mdgriffith$elm_ui$Element$text('減'))
				])));
};
...
var author$project$CounterElmUi$main = elm$browser$Browser$sandbox(

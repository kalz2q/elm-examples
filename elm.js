...
var author$project$Main$GotRepo = function (a) {
	return {$: 'GotRepo', a: a};
};
	...
	function (msg, model) {
		if (msg.$ === 'Click') {
			return _Utils_Tuple2(
				...
				elm$http$Http$get(
					{
						expect: elm$http$Http$expectString(author$project$Main$GotRepo),
			...
			if (msg.a.$ === 'Ok') {
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							result: elm$core$Debug$toString(error)
						}),
					elm$core$Platform$Cmd$none);
			}
		}
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text('Get Repository Info')
					])),
				A2(
				elm$html$Html$p,
				_List_Nil,

...
main =
    div []
        ...
        , ul []
            [ li [] [ a [ href "src/helloworldattribute.html" ] [ text "attribute付きハローワールド" ] ]
            , li [] [ a [ href "src/helloworlddiv.html" ] [ text "div付きハローワールド" ] ]
            , li [] [ a [ href "src/helloworldtype.html" ] [ text "型付きハローワールド" ] ]
            , li [] [ a [ href "src/helloworld01.html" ] [ text "一番簡単なElmによるハローワールド" ] ]
            , li [] [ a [ href "src/helloworldcss.html" ] [ text "cssの組み込み実験" ] ]
